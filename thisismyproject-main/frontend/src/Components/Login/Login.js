          ...
          <div className="flex h-full items-center justify-center" style={{ backgroundColor: '#fcf5ff' }}>
            <div className="flex-1 max-w-md p-8 bg-transparent shadow-black rounded-lg shadow-2xl " style={{ backgroundColor: "black" }}> 
              <form className="login" onSubmit={handleSubmit}>
                ...
                <button
                  disabled={isLoading}
                  className={`w-full mb-4 mt-4 p-2 bg-blue-500 text-white font-bold rounded-md transition-transform transform hover:scale-125 ${isLoading ? "bg-blue-300 cursor-not-allowed" : "hover:bg-blue-700"}`}
                >
                  {loginIcon} Log in
                </button>
              ...
              <div className="text-center">
                {user ? (
                  <button
                    className="w-full mb-4 mt-4 p-2 bg-blue-800 text-white font-bold rounded-md hover:bg-green-700 transition-transform transform hover:scale-125"
              ...
              <div>
                <Link
                  to="/GettingStarted"
                  className="bg-blue-500 hover:bg-red-500 text-white font-bold py-2 px-4 rounded inline-block transition-transform transform hover:scale-110"
                >
                  getting started
                </Link>
              </div>
